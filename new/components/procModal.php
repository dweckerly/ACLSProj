<div class="modal fade" id="procedure-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
?>
                <button data="<?php echo $row['id'];?>" data-type="<?php echo $type; ?>" data-tag="<?php echo $row['dataTag'];?>" class="btn btn-outline-secondary proc-btn"><?php echo $row['name'];?></button>
<?php
}
?>
            </div>
